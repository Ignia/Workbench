...
namespace Ignia.Workbench.DeconstructedWebApi {
  ...
  /// <summary>
  ///   Provides a custom implementation of the <see cref="UserManager{TUser}"/> class, which may be extended on a per application basis to add support for custom properties.
  /// </summary>
